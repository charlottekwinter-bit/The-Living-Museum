...
NUMBER_ENTRIES = {
    "zero": {"what": "Zero is not the absence of number — it is the number for absence. This distinction took humanity thousands of years to make. The Babylonians had a placeholder for zero but did not treat it as a number in its own right. The concept of zero as a number appears in Indian mathematics around the 5th century CE. Without zero, decimal notation is impossible. Without zero, algebra cannot function. The entire edifice of modern mathematics rests on a concept that felt, for most of history, like a contradiction in terms.", "feel": "Zero is the number that broke through a boundary. It is the number that says: the absence of things is itself a thing, and we can calculate with it."},
